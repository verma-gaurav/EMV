...
class SpaceXMultimedia extends StatefulWidget {
  @override
  State<SpaceXMultimedia> createState() => _SpaceXMultimediaState();
}

class _SpaceXMultimediaState extends State<SpaceXMultimedia> {
  var forum = [];
  ...
  getMultimediaList() async {
    var forumFromApi = await getSpaceXMultimedia();
    setState(() {
      forum = forumFromApi;
    });
  }
