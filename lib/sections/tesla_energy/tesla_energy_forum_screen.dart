...
class TslaEnergyForumScreen extends StatefulWidget {
  @override
  State<TslaEnergyForumScreen> createState() => _TslaEnergyForumScreenState();
}

class _TslaEnergyForumScreenState extends State<TslaEnergyForumScreen> {
  var forum = [];
